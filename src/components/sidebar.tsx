...
export function SidebarContent({
  ...
  return (
    <div className={cn('flex-1 overflow-y-auto overflow-x-hidden px-3', className)}>{children}</div>
  );
}
...
export function SidebarFooter({
  ...
  return (
    <div
      className={cn(
        'mt-auto flex flex-col gap-2 border-t border-[color-mix(in_srgb,var(--color-cream)_8%,transparent)] p-3',
        className
      )}
    >
      {children}
...
export function SidebarGroupLabel({
  ...
  return (
    <p
      className={cn(
        'card-eyebrow mb-1 px-2.5 pt-2 group-data-[state=collapsed]/sidebar:hidden',
        className
      )}
    >
      {children}
...
export function SidebarMenuSub({
  ...
  return (
    <ul
      className={cn(
        'ml-[1.15rem] flex flex-col gap-0.5 border-l border-white/[0.07] pl-2.5 group-data-[state=collapsed]/sidebar:hidden',
        className
      )}
    >
      {children}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        isActive
          ? 'bg-white/[0.05] font-semibold text-cream'
          : 'text-cream/50 hover:bg-white/[0.035] hover:text-cream/85',
        className
      )}
    >
      {children}
