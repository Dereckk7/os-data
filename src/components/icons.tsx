...
export function LogoMark({ size = 24, className }: { size?: number; className?: string }) {
  return (
    ...
    >
      <path
        d="M3 5.5c5.6 0 6.2 6.5 10.6 6.5"
        stroke="currentColor"
        strokeOpacity="0.85"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      />
      <path
        d="M3 18.5c5.6 0 6.2-6.5 10.6-6.5"
        stroke="currentColor"
        strokeOpacity="0.85"
        strokeWidth="1.5"
        strokeLinecap="round"
      ...
      <path
        d="M18.6 12h2.6m0 0-1.9-1.9m1.9 1.9-1.9 1.9"
        stroke="#C9B27C"
        strokeWidth="1.5"
        strokeLinecap="round"
  ...
  return (
    <span className={`inline-flex items-center gap-2.5 ${className ?? ''}`}>
      ...
      <span className="flex flex-col leading-none">
        ...
        {withTagline && (
          <span className="mt-1 text-[10px] tracking-[0.08em] text-cream/40">
            Votre entreprise, enfin connectée
          </span>
        )}
      </span>
    </span>
...
export function GoogleIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" aria-hidden="true">
      <path
        fill="currentColor"
        d="M21.6 12.23c0-.68-.06-1.36-.19-2.02H12v3.83h5.4a4.6 4.6 0 0 1-2 3.02v2.5h3.24c1.9-1.74 2.96-4.3 2.96-7.33Z"
      />
      <path
        fill="currentColor"
        opacity=".7"
        d="M12 21.75c2.7 0 4.96-.9 6.62-2.42l-3.24-2.5c-.9.6-2.04.95-3.38.95-2.6 0-4.8-1.75-5.58-4.1H3.06v2.58A10 10 0 0 0 12 21.75Z"
      />
      <path
        fill="currentColor"
        opacity=".45"
        d="M6.42 13.68a6 6 0 0 1 0-3.83V7.27H3.06a10 10 0 0 0 0 8.99l3.36-2.58Z"
      />
      <path
        fill="currentColor"
        opacity=".85"
        d="M12 6.23c1.47 0 2.78.5 3.82 1.5l2.86-2.86A9.97 9.97 0 0 0 12 2.25a10 10 0 0 0-8.94 5.02l3.36 2.58C7.2 7.98 9.4 6.23 12 6.23Z"
      />
    </svg>
  );
}
...
const agentIcons: Record<string, LucideIcon> = {
  'ag-resa': ConciergeBell,
  'ag-ci': Fingerprint,
  'ag-rep': BarChart3,
  'ag-ops': Workflow,
  'ag-pros': Radar,
  'ag-tres': Wallet,
  'ag-com': MessageCircle,
  'ag-plan': CalendarDays,
  'ag-part': Building2,
  'ag-veil': ShieldCheck,
};
